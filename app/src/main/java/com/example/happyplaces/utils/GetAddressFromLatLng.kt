...
class GetAddressFromLatLng(
     ...
     */
    /**It takes care of encoding the Geolocation to something that's readable. it converts the Lng & Lat into readable text(address)*/
        ...
        try {
            ...
            if (addressList != null && addressList.isNotEmpty()) {
                ...
                for (i in 0..address.maxAddressLineIndex) {
                    sb.append(address.getAddressLine(i)).append(" ") //Inserts spaces between the address string
                }
    ...
    /**
     * A public fun that takes care of getting the address
       A public function to execute the AsyncTask from the class is it called.
    */

    fun getAddress(){
        execute()  //An AsyncTask doesn't do anything unless it is executed
    }
